...
namespace PoissonProcess.Classes
{
    /// <summary>
    ...
    public class Poisson
    {
        ...
        public Poisson(double intenrval = 1, double duration = 20, double intensity=1)
        {
            Duration = duration;
            Interval = intenrval;
            Intensity = intensity;
            _distribution = new DistributionClass(intensity, 0, "Експоненційний", 0);
        ...
        {            
            ...
            while (Interval * i <= Duration)
            {
                ...
                var time = _distribution.DistributionChoice();
