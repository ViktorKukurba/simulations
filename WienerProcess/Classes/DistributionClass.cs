...
namespace M2.Classes
{
    ...
    /// </summary>
    public class CopyOfDistributionClass
    {
        //private int state;
        /// <summary>
        /// Random Number
        ...
        public double DistributionChoice(double? a = null, double? b = null)
        {
            if (a.HasValue) this.a = a.Value;
            if (b.HasValue) this.b = b.Value;
            double x = 0;
        ...
        public CopyOfDistributionClass(double a, double b, string distributionName, double rand)
        {
