...
namespace LotkaVolterra
{
    ...
    public partial class ProgramInterface : Form
    {
        ...
        {
            LVSimulation lvSimulation = new MatLabLVSimulation(); //PyLVSimulation(); MatLabLVSimulation
            ...
            var j = Convert.ToDouble(textBoxJ.Text);
            ...
            var noPerturbedList = lvSimulation.Generate(start, finish, a, b, c, d, n0, p0,j);
            var noPerturbedsapList = lvSimulation.SAPProcess(start, finish, a, b, c, d, n0, p0, alpha,j);
            ...
            foreach (var semiMarkovPoint in semiMarkovPoints)
            {
                ...
                sapList.AddRange(lvSimulation.SAPProcess(semiMarkovPoint.StartMoment, semiMarkovPoint.EndMoment, a, b, c, d, n01, p01, alpha, j));
                list.AddRange(lvSimulation.Generate(semiMarkovPoint.StartMoment, semiMarkovPoint.EndMoment, a, b, c, d, n0, p0, j));
            }
            ...
            graphProcess.DrawPN(graphPN, list, noPerturbedList, "Модель Лотка Вольтерра");
